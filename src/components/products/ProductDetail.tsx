    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="glass-card p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          ...
          <div className="stat-card">
            <span className="text-xs text-muted-foreground flex items-center gap-1">
              <DollarSign className="w-3 h-3" />管理费
            </span>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="glass-card p-6">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-2">地区限制</h3>
              <div className="flex flex-wrap gap-2">
            ...
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-2">公司资质要求</h3>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                {product.supportsFiat && (
                  <span className="chip-success">法币</span>
                )}
                {product.supportsStablecoin && (
                  <span className="chip-success">稳定币</span>
                )}
              </div>
            </div>
              ...
              <div className="p-4 rounded-lg bg-muted/30">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">最低门槛</span>
      ...
      <div className="glass-card p-6 gradient-border">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm">一键直达官方开户通道或联系专属顾问</p>
          </div>
